...
<head>
    ...
    <link rel="stylesheet" href="fulldemo.css"/>
    <script src="fulldemo.js"></script>
</head>
<body>
    <header class="header">
        ScrollProxy library full demo
    </header>
    <div class="demo">
    <?php
    ...
    ?>
            ...
            <div class="col col--5">
                <aside class="section__gallery">
                    <div class="gallery__image-wrapper">
                        <img class="gallery__image" src="img/landscape-4.jpg"/>
                    </div>
                    <div class="gallery__image-wrapper">
                        <img class="gallery__image" src="img/landscape-3.jpg"/>
                    </div>
                    <div class="gallery__image-wrapper">
                        <img class="gallery__image" src="img/landscape-2.jpg"/>
                    </div>
                    <div class="gallery__image-wrapper">
                        <img class="gallery__image" src="img/landscape-1.jpg"/>
                    </div>
                </aside>
            </div>
            <div class="col col--7 section__content-wrapper">
                <content class="section__content">
                    <h2 class="section__title"><?php echo strip_tags($titles[2]); ?></h2>
                    <?php foreach ([$lorem[0], $lorem[2], $lorem[3]] as $paragraph) {
                        echo $paragraph;
                    } ?>
                </content>
            </div>
        ...
        for ($i = 0; $i < 10; $i++) {
            ...
            shuffle($lorem);
            shuffle($titles);
            $sectionImages = array_slice($images, 0, rand(1, 4));
