...
<body>
    <div class="demo-controls__wrapper">
        <div class="demo-controls">
            <button class="button" data-bubbles="100">100</button>
            <button class="button" data-bubbles="500">500</button>
            <button class="button" data-bubbles="1000">1000</button>
            <button class="button" data-bubbles="2000">2000</button>
        </div>
    </div>
</body>
</html>
